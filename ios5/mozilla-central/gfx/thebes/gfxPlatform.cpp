...
#if defined(XP_MACOSX) || defined(XP_IOS) || defined(XP_WIN) || defined(ANDROID) // temporary, until this is implemented on others
...
#endif
#if defined(XP_MACOSX) || defined(XP_IOS) || defined(XP_WIN) // temporary, until this is implemented on others
