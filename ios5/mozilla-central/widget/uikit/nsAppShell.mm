...
{
  nsAdoptingCString value = Preferences::GetCString("ipc.channel.socket.host");
  if (value)
    setenv("MOZ_IPC_CHANNEL_SOCKET_HOST", value.get(), 1);
  system("echo MOZ_IPC_CHANNEL_SOCKET_HOST: $MOZ_IPC_CHANNEL_SOCKET_HOST");
